...
class Toast extends GetSnackBar {
  const Toast({
    Key? key,
    super.title,
    super.message,
    ...
    super.messageText,
    super.icon,
    super.shouldIconPulse = true,
    super.maxWidth,
    super.margin = const EdgeInsets.all(0.0),
    super.padding = const EdgeInsets.all(16),
    super.borderRadius = 0.0,
    super.borderColor,
    super.borderWidth = 1.0,
    super.backgroundColor = const Color(0xFF303030),
    ...
    super.showProgressIndicator = false,
    super.progressIndicatorController,
    super.progressIndicatorBackgroundColor,
    super.progressIndicatorValueColor,
    super.snackPosition = SnackPosition.BOTTOM,
    super.snackStyle = SnackStyle.FLOATING,
    super.forwardAnimationCurve = Curves.easeOutCirc,
    super.reverseAnimationCurve = Curves.easeOutCirc,
    super.animationDuration = const Duration(seconds: 1),
    super.barBlur = 0.0,
    super.overlayBlur = 0.0,
    super.overlayColor = Colors.transparent,
    super.userInputForm,
    super.snackbarStatus,
  }) : super(key: key);

  @override
  State createState() => ToastState();
}

class ToastState extends State<Toast> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    assert(
        ...
        '''
You need to either use message[String], or messageText[Widget] or define a userInputForm[Form] in Toast''');
